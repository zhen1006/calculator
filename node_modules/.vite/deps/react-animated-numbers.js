...
var require_dist = __commonJS({
  "node_modules/react-animated-numbers/dist/index.js"(exports) {
    ...
    var generateRandomSequence = (target, length = 40) => {
      const base = Array.from({ length: length - 1 }, () => Math.floor(Math.random() * 10));
      return [...base, target];
    };
    var AnimatedNumber = ({ className, animateToNumber, fontStyle, transitions, useThousandsSeparator = false, locale = "en-US" }) => {
      ...
      const animateNumberStr = useThousandsSeparator ? Math.abs(animateToNumber).toLocaleString(locale) : String(Math.abs(animateToNumber));
      (0, react_1.useEffect)(() => {
      ...
      return react_1.default.createElement(
        "span",
        { ref: wrapperRef, style: { position: "relative", display: "inline-block" } },
        numberHeight > 0 && react_1.default.createElement("div", { className, style: {
          display: "flex",
          overflow: "hidden",
          flexDirection: "row",
          position: "relative"
