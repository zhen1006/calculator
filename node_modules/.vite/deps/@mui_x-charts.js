...
<<<<<<< HEAD
} from "./chunk-BBD7HHIR.js";
import {
  useThemeProps
} from "./chunk-PBZ5NSOS.js";
import "./chunk-QRB4WGAM.js";
=======
} from "./chunk-ITPEPQWM.js";
import "./chunk-JLPWKB6T.js";
import {
  require_react_dom
} from "./chunk-TH7NCS4R.js";
import {
  useThemeProps
} from "./chunk-R4CCCPTP.js";
...
import {
  ...
  useTheme
<<<<<<< HEAD
} from "./chunk-5WVSX5HI.js";
=======
} from "./chunk-ZDMRMY43.js";
>>>>>>> 3091d3657786ba31276672684014deafbfd6cc4d
...
function RtlProvider({
  ...
  return (0, import_jsx_runtime13.jsx)(RtlContext.Provider, {
    value: value ?? true,
    ...props
  });
}
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime15.jsxs)(React35.Fragment, {
...
function deepClone(source) {
  if (React43.isValidElement(source) || (0, import_react_is.isValidElementType)(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (React43.isValidElement(source[key]) || (0, import_react_is.isValidElementType)(source[key])) {
...
function createGrid(options = {}) {
  ...
  const Grid2 = React61.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime31.jsx)(GridRoot2, {
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React66.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React66.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const getItemSpace = React71.useCallback((label, inStyle = {}) => {
    const style4 = _objectWithoutPropertiesLoose(inStyle, _excluded7);
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React71.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React71.useMemo(() => {
  ...
  return (0, import_jsx_runtime39.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime39.jsx)(ChartsLegendRoot, {
      ...
      children: itemsWithPosition.map((item, i) => (0, import_react4.createElement)(ChartsLegendItem, _extends({}, item, {
        key: item.id,
        gapX,
        gapY,
        legendWidth,
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime43.jsxs)(React76.Fragment, {
    ...
    }), (0, import_jsx_runtime43.jsx)("rect", _extends({
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime44.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime45.jsxs)(React78.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime45.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime45.jsx)(ChartsAxisHighlightPath, {
...
function ChartsVoronoiHandler(props) {
  ...
  const voronoiRef = React79.useRef({});
  const delauneyRef = React79.useRef(void 0);
  const lastFind = React79.useRef(void 0);
  const {
    setHighlighted,
    clearHighlighted
  } = useHighlighted();
  ...
  return (0, import_jsx_runtime46.jsx)(React79.Fragment, {});
}
true ? ChartsVoronoiHandler.propTypes = {
   ...
   */
  voronoiMaxRadius: import_prop_types35.default.number
} : void 0;
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime47.jsx)(React80.Fragment, {});
}
...
function usePrev(value) {
  const prevRef = (0, import_react11.useRef)();
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react13.forwardRef)((givenProps, givenRef) => {
    ...
    return React81.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React82.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React82.createContext(init));
...
function useTransition(data, props, deps) {
  ...
  const transitions = [];
  const usedTransitions = (0, import_react17.useRef)(null);
  ...
  const exitingTransitions = (0, import_react17.useRef)(/* @__PURE__ */ new Map());
  const forceChange = (0, import_react17.useRef)(false);
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(Bar, _extends({}, barProps));
}
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime49.jsx)(animated.rect, {
...
function BarClipPath(props) {
  ...
  return (0, import_jsx_runtime49.jsx)("clipPath", {
    id: maskId,
    children: (0, import_jsx_runtime49.jsx)(BarClipRect, {
      ownerState: rest,
      style: style4
    })
  });
...
function BarLabel(inProps) {
  ...
  return (0, import_jsx_runtime50.jsx)(BarLabelComponent, _extends({}, otherProps));
}
...
function BarLabelItem(props) {
  ...
  return (0, import_jsx_runtime51.jsx)(Component, _extends({}, barLabelProps, barLabelOwnerState, {
...
true ? BarLabelItem.propTypes = {
   ...
   */
  barLabel: import_prop_types39.default.oneOfType([import_prop_types39.default.oneOf(["value"]), import_prop_types39.default.func]),
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime52.jsx)(React88.Fragment, {
    children: barLabelTransition((style4, {
      ...
      width: width2,
      height: height2
    }) => (0, import_jsx_runtime52.jsx)(BarLabelItem, _extends({
      seriesId,
      dataIndex,
      value,
      color: color3,
...
var AnimationContext = React89.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React90.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime53.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React91.useContext(AnimationContext);
  if (!isInitialized) {
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime54.jsxs)(React92.Fragment, {
    children: [!withoutBorderRadius && maskTransition((style4, {
      ...
      return (0, import_jsx_runtime54.jsx)(BarClipPath, {
        maskId: id,
        borderRadius: borderRadius2,
        hasNegative,
        hasPositive,
      ...
      const barElement = (0, import_jsx_runtime54.jsx)(BarElement, _extends({
        id: seriesId,
        dataIndex,
        color: color3
      }, other, {
    ...
    }), barLabel && (0, import_jsx_runtime54.jsx)(BarLabelPlot, _extends({
      bars: completedData,
      skipAnimation: skipAnimation2,
      barLabel
    }, other))]
...
true ? BarPlot.propTypes = {
   ...
   * @returns {string} The formatted label.
   */
  barLabel: import_prop_types40.default.oneOfType([import_prop_types40.default.oneOf(["value"]), import_prop_types40.default.func]),
  /**
   * Defines the border radius of the bar element.
   */
  borderRadius: import_prop_types40.default.number,
  /**
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React93.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React94.forwardRef(function ChartsSurface2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiChartsSurface"
  });
  ...
  return (0, import_jsx_runtime55.jsxs)(ChartChartsSurfaceStyles, _extends({
    width: width2,
    height: height2,
    ...
    children: [(0, import_jsx_runtime55.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime55.jsx)("desc", {
      children: desc
    }), children]
  }));
});
true ? ChartsSurface.propTypes = {
   ...
   */
  height: import_prop_types41.default.number.isRequired,
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime56.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      const offset = isReversed ? 1 - x2 / size : x2 / size;
      return (0, import_jsx_runtime56.jsxs)(React95.Fragment, {
...
function useChartGradient() {
  const {
    chartId
  } = React96.useContext(DrawingContext);
  return React96.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
  ...
  return (0, import_jsx_runtime57.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime57.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale: scale2,
          colorScale,
          colorMap,
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React97.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React97.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var ChartContainer = React99.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
  ...
  return (0, import_jsx_runtime58.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime58.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime58.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime58.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
          children: (0, import_jsx_runtime58.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime58.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime58.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime58.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime58.jsx)(ChartsAxesGradients, {}), (0, import_jsx_runtime58.jsx)(AnimationProvider, _extends({}, animationProviderProps, {
                    children
                  }))]
                }))
              }))
...
true ? ChartContainer.propTypes = {
   ...
   */
  plugins: import_prop_types42.default.arrayOf(import_prop_types42.default.object),
  /**
  ...
  xAxis: import_prop_types42.default.arrayOf(import_prop_types42.default.shape({
    ...
    domainLimit: import_prop_types42.default.oneOfType([import_prop_types42.default.oneOf(["nice", "strict"]), import_prop_types42.default.func]),
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types42.default.arrayOf(import_prop_types42.default.shape({
    colorMap: import_prop_types42.default.oneOfType([import_prop_types42.default.shape({
      colors: import_prop_types42.default.arrayOf(import_prop_types42.default.string).isRequired,
      type: import_prop_types42.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types42.default.string,
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  const stateRef = React100.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const rootRef = React100.useRef(null);
  const [width2, setWidth] = React100.useState(0);
  const [height2, setHeight] = React100.useState(0);
  const computeSize = React100.useCallback(() => {
...
var ResponsiveChartContainer = React101.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime59.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime59.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
true ? ResponsiveChartContainer.propTypes = {
   ...
   * If not provided, the container supports line, bar, scatter and pie charts.
   */
  plugins: import_prop_types43.default.arrayOf(import_prop_types43.default.object),
  /**
  ...
  xAxis: import_prop_types43.default.arrayOf(import_prop_types43.default.shape({
    ...
    domainLimit: import_prop_types43.default.oneOfType([import_prop_types43.default.oneOf(["nice", "strict"]), import_prop_types43.default.func]),
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types43.default.arrayOf(import_prop_types43.default.shape({
    colorMap: import_prop_types43.default.oneOfType([import_prop_types43.default.shape({
      colors: import_prop_types43.default.arrayOf(import_prop_types43.default.string).isRequired,
      type: import_prop_types43.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types43.default.string,
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime60.jsx)(StyledText, _extends({
    x: left2 + width2 / 2,
    y: top2 + height2 / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime61.jsx)(StyledText2, _extends({
    x: left2 + width2 / 2,
    y: top2 + height2 / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime62.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime62.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var BarChart = React105.forwardRef(function BarChart2(inProps, ref) {
  ...
  return (0, import_jsx_runtime63.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime63.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime63.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime63.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime63.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime63.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime63.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime63.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime63.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime63.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime63.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? BarChart.propTypes = {
   ...
   * @returns {string} The formatted label.
   */
  barLabel: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["value"]), import_prop_types44.default.func]),
  /**
   * Defines the border radius of the bar element.
   */
  borderRadius: import_prop_types44.default.number,
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   ...
   * @default 'vertical'
   */
  layout: import_prop_types44.default.oneOf(["horizontal", "vertical"]),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types44.default.bool,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
  ...
  xAxis: import_prop_types44.default.arrayOf(import_prop_types44.default.shape({
    ...
    domainLimit: import_prop_types44.default.oneOfType([import_prop_types44.default.oneOf(["nice", "strict"]), import_prop_types44.default.func]),
...
var useStringInterpolator = (path2) => {
  ...
  const interpolator = React106.useMemo(() => memoryRef.previousPath ? string_default(memoryRef.previousPath, memoryRef.currentPath) : () => memoryRef.currentPath, [memoryRef.currentPath, memoryRef.previousPath]);
  return interpolator;
};
...
function AppearingMask(props) {
  ...
  return (0, import_jsx_runtime64.jsxs)(React107.Fragment, {
    children: [(0, import_jsx_runtime64.jsx)("clipPath", {
      id: clipId,
      children: transitionAppear((style4) => (0, import_jsx_runtime64.jsx)(animated.rect, {
        // @ts-expect-error
        x: 0,
        y: 0,
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime65.jsx)(AppearingMask, {
    ...
    children: transitionChange((style4, interpolator) => (
      // @ts-expect-error
      (0, import_jsx_runtime65.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime66.jsx)(Area, _extends({}, other, areaProps));
}
...
var useAggregatedData2 = () => {
  ...
  const axisData = useCartesianContext();
  const allData = React110.useMemo(() => {
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime67.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime67.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color3,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime68.jsx)(AppearingMask, {
    skipAnimation: skipAnimation2,
    id: `${ownerState.id}-line-clip`,
    children: transitionChange((style4, interpolator) => (
      // @ts-expect-error
      (0, import_jsx_runtime68.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: style4.value.to(interpolator)
      }))
    ))
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime69.jsx)(Line, _extends({}, other, lineProps));
}
...
var useAggregatedData3 = () => {
  const seriesData = useLineSeries();
  const axisData = useCartesianContext();
  const allData = React113.useMemo(() => {
    if (seriesData === void 0) {
      return [];
    }
    const {
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime70.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime70.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color3,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
function CircleMarkElement(props) {
  ...
  return (0, import_jsx_runtime71.jsx)(animated.circle, _extends({}, other, {
    // @ts-expect-error
    cx: position2.x,
    cy: position2.y,
    r: 5,
...
true ? CircleMarkElement.propTypes = {
   ...
   */
  dataIndex: import_prop_types51.default.number.isRequired,
...
function MarkElement(props) {
  ...
  const classes = useUtilityClasses12(ownerState);
  return (0, import_jsx_runtime72.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
true ? MarkElement.propTypes = {
   ...
   * The index to the element in the series' data array.
   */
  dataIndex: import_prop_types52.default.number.isRequired,
   ...
   * The shape of the marker.
   */
  shape: import_prop_types52.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired,
  /**
   * If `true`, animations are skipped.
   * @default false
   */
...
function MarkPlot(props) {
  ...
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  return (0, import_jsx_runtime73.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime73.jsx)("g", {
          clipPath: `url(#${clipId})`,
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime73.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
true ? MarkPlot.propTypes = {
   ...
   * @default false
   */
  experimentalRendering: import_prop_types53.default.bool,
  /**
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime74.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
  ...
  return (0, import_jsx_runtime75.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime75.jsx)(Element, _extends({
          id: seriesId,
...
var LineChart = React119.forwardRef(function LineChart2(inProps, ref) {
  ...
  return (0, import_jsx_runtime76.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime76.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime76.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime76.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime76.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime76.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime76.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime76.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime76.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime76.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime76.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime76.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime76.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime76.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime76.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   * @default { x: 'line' }
   */
  axisHighlight: import_prop_types56.default.shape({
    x: import_prop_types56.default.oneOf(["band", "line", "none"]),
    y: import_prop_types56.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types56.default.oneOfType([import_prop_types56.default.object, import_prop_types56.default.string]),
   ...
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types56.default.arrayOf(import_prop_types56.default.object),
   ...
   */
  disableLineItemHighlight: import_prop_types56.default.bool,
  /**
   * If `true` marks will render `<circle />` instead of `<path />` and drop theme override for faster rendering.
   */
  experimentalMarkRendering: import_prop_types56.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types56.default.shape({
    horizontal: import_prop_types56.default.bool,
  ...
  highlightedItem: import_prop_types56.default.shape({
    ...
    seriesId: import_prop_types56.default.oneOfType([import_prop_types56.default.number, import_prop_types56.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types56.default.oneOfType([import_prop_types56.default.object, import_prop_types56.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types56.default.shape({
    classes: import_prop_types56.default.object,
    direction: import_prop_types56.default.oneOf(["column", "row"]),
    hidden: import_prop_types56.default.bool,
    itemGap: import_prop_types56.default.number,
    itemMarkHeight: import_prop_types56.default.number,
    itemMarkWidth: import_prop_types56.default.number,
    labelStyle: import_prop_types56.default.object,
    markGap: import_prop_types56.default.number,
    onItemClick: import_prop_types56.default.func,
    padding: import_prop_types56.default.oneOfType([import_prop_types56.default.number, import_prop_types56.default.shape({
    ...
    position: import_prop_types56.default.shape({
      horizontal: import_prop_types56.default.oneOf(["left", "middle", "right"]).isRequired,
      vertical: import_prop_types56.default.oneOf(["bottom", "middle", "top"]).isRequired
    }),
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types56.default.shape({
    bottom: import_prop_types56.default.number,
    left: import_prop_types56.default.number,
    right: import_prop_types56.default.number,
    top: import_prop_types56.default.number
   ...
   */
  onAreaClick: import_prop_types56.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   * @param {null | AxisData} data The data about the clicked axis and items associated with it.
   */
  onAxisClick: import_prop_types56.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   ...
   */
  onLineClick: import_prop_types56.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types56.default.func,
  /**
   * The chart will try to wait for the parent container to resolve its size
   * before it renders for the first time.
   *
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types56.default.bool,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types56.default.oneOfType([import_prop_types56.default.object, import_prop_types56.default.string]),
  /**
   ...
   */
  tooltip: import_prop_types56.default.shape({
    axisContent: import_prop_types56.default.elementType,
    classes: import_prop_types56.default.object,
    itemContent: import_prop_types56.default.elementType,
    slotProps: import_prop_types56.default.object,
    slots: import_prop_types56.default.object,
    trigger: import_prop_types56.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types56.default.oneOfType([import_prop_types56.default.object, import_prop_types56.default.string]),
  viewBox: import_prop_types56.default.shape({
    height: import_prop_types56.default.number,
    width: import_prop_types56.default.number,
    x: import_prop_types56.default.number,
    y: import_prop_types56.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types56.default.arrayOf(import_prop_types56.default.shape({
    classes: import_prop_types56.default.object,
    colorMap: import_prop_types56.default.oneOfType([import_prop_types56.default.shape({
      colors: import_prop_types56.default.arrayOf(import_prop_types56.default.string).isRequired,
      type: import_prop_types56.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types56.default.string,
      values: import_prop_types56.default.arrayOf(import_prop_types56.default.oneOfType([import_prop_types56.default.instanceOf(Date), import_prop_types56.default.number, import_prop_types56.default.string]).isRequired)
    }), import_prop_types56.default.shape({
      color: import_prop_types56.default.oneOfType([import_prop_types56.default.arrayOf(import_prop_types56.default.string.isRequired), import_prop_types56.default.func]).isRequired,
      max: import_prop_types56.default.oneOfType([import_prop_types56.default.instanceOf(Date), import_prop_types56.default.number]),
      min: import_prop_types56.default.oneOfType([import_prop_types56.default.instanceOf(Date), import_prop_types56.default.number]),
      type: import_prop_types56.default.oneOf(["continuous"]).isRequired
    }), import_prop_types56.default.shape({
      colors: import_prop_types56.default.arrayOf(import_prop_types56.default.string).isRequired,
      thresholds: import_prop_types56.default.arrayOf(import_prop_types56.default.oneOfType([import_prop_types56.default.instanceOf(Date), import_prop_types56.default.number]).isRequired).isRequired,
      type: import_prop_types56.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types56.default.array,
    dataKey: import_prop_types56.default.string,
    disableLine: import_prop_types56.default.bool,
    disableTicks: import_prop_types56.default.bool,
    domainLimit: import_prop_types56.default.oneOfType([import_prop_types56.default.oneOf(["nice", "strict"]), import_prop_types56.default.func]),
    fill: import_prop_types56.default.string,
    hideTooltip: import_prop_types56.default.bool,
    id: import_prop_types56.default.oneOfType([import_prop_types56.default.number, import_prop_types56.default.string]),
    label: import_prop_types56.default.string,
    labelFontSize: import_prop_types56.default.number,
    labelStyle: import_prop_types56.default.object,
    max: import_prop_types56.default.oneOfType([import_prop_types56.default.instanceOf(Date), import_prop_types56.default.number]),
    min: import_prop_types56.default.oneOfType([import_prop_types56.default.instanceOf(Date), import_prop_types56.default.number]),
    position: import_prop_types56.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types56.default.bool,
    scaleType: import_prop_types56.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types56.default.object,
    slots: import_prop_types56.default.object,
    stroke: import_prop_types56.default.string,
    sx: import_prop_types56.default.oneOfType([import_prop_types56.default.arrayOf(import_prop_types56.default.oneOfType([import_prop_types56.default.func, import_prop_types56.default.object, import_prop_types56.default.bool])), import_prop_types56.default.func, import_prop_types56.default.object]),
    tickFontSize: import_prop_types56.default.number,
    tickInterval: import_prop_types56.default.oneOfType([import_prop_types56.default.oneOf(["auto"]), import_prop_types56.default.array, import_prop_types56.default.func]),
    tickLabelInterval: import_prop_types56.default.oneOfType([import_prop_types56.default.oneOf(["auto"]), import_prop_types56.default.func]),
    tickLabelPlacement: import_prop_types56.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types56.default.object,
    tickMaxStep: import_prop_types56.default.number,
    tickMinStep: import_prop_types56.default.number,
    tickNumber: import_prop_types56.default.number,
    tickPlacement: import_prop_types56.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types56.default.number,
    valueFormatter: import_prop_types56.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types56.default.arrayOf(import_prop_types56.default.shape({
    classes: import_prop_types56.default.object,
    colorMap: import_prop_types56.default.oneOfType([import_prop_types56.default.shape({
      colors: import_prop_types56.default.arrayOf(import_prop_types56.default.string).isRequired,
      type: import_prop_types56.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types56.default.oneOfType([import_prop_types56.default.instanceOf(Date), import_prop_types56.default.number]),
    min: import_prop_types56.default.oneOfType([import_prop_types56.default.instanceOf(Date), import_prop_types56.default.number]),
    position: import_prop_types56.default.oneOf(["left", "right"]),
    reverse: import_prop_types56.default.bool,
    scaleType: import_prop_types56.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types56.default.object,
    slots: import_prop_types56.default.object,
...
function PieArc(props) {
  ...
  const getInteractionItemProps = useInteractionItemProps();
  return (0, import_jsx_runtime77.jsx)(PieArcRoot, _extends({
...
true ? PieArc.propTypes = {
  ...
  dataIndex: import_prop_types57.default.number.isRequired,
  /**
   * @deprecated Use the `isFaded` or `isHighlighted` props instead.
   */
  highlightScope: import_prop_types57.default.shape({
    fade: import_prop_types57.default.oneOf(["global", "none", "series"]),
    faded: import_prop_types57.default.oneOf(["global", "none", "series"]),
    highlight: import_prop_types57.default.oneOf(["item", "none", "series"]),
    highlighted: import_prop_types57.default.oneOf(["item", "none", "series"])
  }),
  ...
  isFaded: import_prop_types57.default.bool.isRequired,
  isHighlighted: import_prop_types57.default.bool.isRequired
} : void 0;
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React121.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime78.jsx)("g", _extends({}, other, {
    children: transition(({
      startAngle,
      endAngle,
      paddingAngle: pA,
      ...
      return (0, import_jsx_runtime78.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcPlot.propTypes = {
   ...
   */
  arcLabelRadius: import_prop_types58.default.number,
  /**
   * The radius applied to arc corners (similar to border radius).
   * @default 0
   */
  cornerRadius: import_prop_types58.default.number,
  data: import_prop_types58.default.arrayOf(import_prop_types58.default.shape({
    color: import_prop_types58.default.string.isRequired,
    endAngle: import_prop_types58.default.number.isRequired,
    formattedValue: import_prop_types58.default.string.isRequired,
    ...
    label: import_prop_types58.default.oneOfType([import_prop_types58.default.func, import_prop_types58.default.string]),
    padAngle: import_prop_types58.default.number.isRequired,
    startAngle: import_prop_types58.default.number.isRequired,
   ...
   */
  faded: import_prop_types58.default.shape({
    additionalRadius: import_prop_types58.default.number,
    arcLabelRadius: import_prop_types58.default.number,
    color: import_prop_types58.default.string,
    cornerRadius: import_prop_types58.default.number,
    innerRadius: import_prop_types58.default.number,
    outerRadius: import_prop_types58.default.number,
    paddingAngle: import_prop_types58.default.number
  }),
  /**
   * Override the arc attributes when it is highlighted.
   */
  highlighted: import_prop_types58.default.shape({
    additionalRadius: import_prop_types58.default.number,
    arcLabelRadius: import_prop_types58.default.number,
    color: import_prop_types58.default.string,
    cornerRadius: import_prop_types58.default.number,
   ...
   */
  outerRadius: import_prop_types58.default.number.isRequired,
  /**
...
function PieArcLabel(props) {
  ...
  return (
    // @ts-expect-error
    (0, import_jsx_runtime79.jsx)(PieArcLabelRoot, _extends({
      className: classes.root
    }, other, {
      style: _extends({
...
true ? PieArcLabel.propTypes = {
  ...
  color: import_prop_types59.default.string.isRequired,
  formattedArcLabel: import_prop_types59.default.string,
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime80.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime80.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types60.default.oneOfType([import_prop_types60.default.oneOf(["formattedValue", "label", "value"]), import_prop_types60.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types60.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
...
function PiePlot(props) {
  ...
  const {
    ...
    width: width2,
    height: height2
  } = React125.useContext(DrawingContext);
  const skipAnimation2 = useSkipAnimation(inSkipAnimation);
  if (seriesData === void 0) {
    return null;
  }
  ...
  return (0, import_jsx_runtime81.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime81.jsx)("g", {
        ...
        children: (0, import_jsx_runtime81.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime81.jsx)("g", {
        transform: `translate(${left2 + cx}, ${top2 + cy})`,
        children: (0, import_jsx_runtime81.jsx)(PieArcLabelPlot, {
          innerRadius,
...
var PieChart = React126.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPieChart"
  });
  ...
  return (0, import_jsx_runtime82.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: series.map((s2) => _extends({
      type: "pie"
    }, s2)),
    ...
    className,
    skipAnimation: skipAnimation2,
    children: [(0, import_jsx_runtime82.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime82.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick
    }), (0, import_jsx_runtime82.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
    }), (0, import_jsx_runtime82.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime82.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime82.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
...
true ? PieChart.propTypes = {
   ...
   */
  axisHighlight: import_prop_types62.default.shape({
    x: import_prop_types62.default.oneOf(["band", "line", "none"]),
    y: import_prop_types62.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  bottomAxis: import_prop_types62.default.oneOfType([import_prop_types62.default.object, import_prop_types62.default.string]),
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types62.default.oneOfType([import_prop_types62.default.arrayOf(import_prop_types62.default.string), import_prop_types62.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types62.default.arrayOf(import_prop_types62.default.object),
  desc: import_prop_types62.default.string,
  /**
   * If `true`, the charts will not listen to the mouse move event.
   * It might break interactive features, but will improve performance.
   * @default false
   */
  disableAxisListener: import_prop_types62.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
  height: import_prop_types62.default.number,
  /**
   * The item currently highlighted. Turns highlighting into a controlled prop.
   */
  highlightedItem: import_prop_types62.default.shape({
    dataIndex: import_prop_types62.default.number,
    seriesId: import_prop_types62.default.oneOfType([import_prop_types62.default.number, import_prop_types62.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  leftAxis: import_prop_types62.default.oneOfType([import_prop_types62.default.object, import_prop_types62.default.string]),
  /**
   * The props of the legend.
   * @default { direction: 'column', position: { vertical: 'middle', horizontal: 'right' } }
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types62.default.shape({
    classes: import_prop_types62.default.object,
    direction: import_prop_types62.default.oneOf(["column", "row"]),
    hidden: import_prop_types62.default.bool,
    itemGap: import_prop_types62.default.number,
    itemMarkHeight: import_prop_types62.default.number,
    itemMarkWidth: import_prop_types62.default.number,
    labelStyle: import_prop_types62.default.object,
    markGap: import_prop_types62.default.number,
    onItemClick: import_prop_types62.default.func,
    padding: import_prop_types62.default.oneOfType([import_prop_types62.default.number, import_prop_types62.default.shape({
      bottom: import_prop_types62.default.number,
      left: import_prop_types62.default.number,
      right: import_prop_types62.default.number,
      top: import_prop_types62.default.number
    })]),
    position: import_prop_types62.default.shape({
      horizontal: import_prop_types62.default.oneOf(["left", "middle", "right"]).isRequired,
      vertical: import_prop_types62.default.oneOf(["bottom", "middle", "top"]).isRequired
    }),
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types62.default.shape({
    bottom: import_prop_types62.default.number,
    left: import_prop_types62.default.number,
    right: import_prop_types62.default.number,
    top: import_prop_types62.default.number
   ...
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   */
  onHighlightChange: import_prop_types62.default.func,
  /**
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types62.default.bool,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types62.default.oneOfType([import_prop_types62.default.object, import_prop_types62.default.string]),
  /**
   * The series to display in the pie chart.
   * An array of [[PieSeriesType]] objects.
   */
  series: import_prop_types62.default.arrayOf(import_prop_types62.default.object).isRequired,
  /**
   * If `true`, animations are skipped.
   * If unset or `false`, the animations respects the user's `prefers-reduced-motion` setting.
   */
   ...
   * @default { trigger: 'item' }
   */
  tooltip: import_prop_types62.default.shape({
    axisContent: import_prop_types62.default.elementType,
    classes: import_prop_types62.default.object,
    itemContent: import_prop_types62.default.elementType,
    slotProps: import_prop_types62.default.object,
    slots: import_prop_types62.default.object,
    trigger: import_prop_types62.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types62.default.oneOfType([import_prop_types62.default.object, import_prop_types62.default.string]),
  viewBox: import_prop_types62.default.shape({
    height: import_prop_types62.default.number,
    width: import_prop_types62.default.number,
    x: import_prop_types62.default.number,
    y: import_prop_types62.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types62.default.arrayOf(import_prop_types62.default.shape({
    classes: import_prop_types62.default.object,
    colorMap: import_prop_types62.default.oneOfType([import_prop_types62.default.shape({
      colors: import_prop_types62.default.arrayOf(import_prop_types62.default.string).isRequired,
      type: import_prop_types62.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types62.default.string,
      values: import_prop_types62.default.arrayOf(import_prop_types62.default.oneOfType([import_prop_types62.default.instanceOf(Date), import_prop_types62.default.number, import_prop_types62.default.string]).isRequired)
    }), import_prop_types62.default.shape({
      color: import_prop_types62.default.oneOfType([import_prop_types62.default.arrayOf(import_prop_types62.default.string.isRequired), import_prop_types62.default.func]).isRequired,
      max: import_prop_types62.default.oneOfType([import_prop_types62.default.instanceOf(Date), import_prop_types62.default.number]),
      min: import_prop_types62.default.oneOfType([import_prop_types62.default.instanceOf(Date), import_prop_types62.default.number]),
      type: import_prop_types62.default.oneOf(["continuous"]).isRequired
    }), import_prop_types62.default.shape({
      colors: import_prop_types62.default.arrayOf(import_prop_types62.default.string).isRequired,
      thresholds: import_prop_types62.default.arrayOf(import_prop_types62.default.oneOfType([import_prop_types62.default.instanceOf(Date), import_prop_types62.default.number]).isRequired).isRequired,
      type: import_prop_types62.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types62.default.array,
    dataKey: import_prop_types62.default.string,
    disableLine: import_prop_types62.default.bool,
    disableTicks: import_prop_types62.default.bool,
    domainLimit: import_prop_types62.default.oneOfType([import_prop_types62.default.oneOf(["nice", "strict"]), import_prop_types62.default.func]),
    fill: import_prop_types62.default.string,
    hideTooltip: import_prop_types62.default.bool,
    id: import_prop_types62.default.oneOfType([import_prop_types62.default.number, import_prop_types62.default.string]),
    label: import_prop_types62.default.string,
    labelFontSize: import_prop_types62.default.number,
    labelStyle: import_prop_types62.default.object,
    max: import_prop_types62.default.oneOfType([import_prop_types62.default.instanceOf(Date), import_prop_types62.default.number]),
    min: import_prop_types62.default.oneOfType([import_prop_types62.default.instanceOf(Date), import_prop_types62.default.number]),
    position: import_prop_types62.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types62.default.bool,
    scaleType: import_prop_types62.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types62.default.object,
    slots: import_prop_types62.default.object,
    stroke: import_prop_types62.default.string,
    sx: import_prop_types62.default.oneOfType([import_prop_types62.default.arrayOf(import_prop_types62.default.oneOfType([import_prop_types62.default.func, import_prop_types62.default.object, import_prop_types62.default.bool])), import_prop_types62.default.func, import_prop_types62.default.object]),
    tickFontSize: import_prop_types62.default.number,
    tickInterval: import_prop_types62.default.oneOfType([import_prop_types62.default.oneOf(["auto"]), import_prop_types62.default.array, import_prop_types62.default.func]),
    tickLabelInterval: import_prop_types62.default.oneOfType([import_prop_types62.default.oneOf(["auto"]), import_prop_types62.default.func]),
    tickLabelPlacement: import_prop_types62.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types62.default.object,
    tickMaxStep: import_prop_types62.default.number,
    tickMinStep: import_prop_types62.default.number,
    tickNumber: import_prop_types62.default.number,
    tickPlacement: import_prop_types62.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types62.default.number,
    valueFormatter: import_prop_types62.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types62.default.arrayOf(import_prop_types62.default.shape({
    classes: import_prop_types62.default.object,
    colorMap: import_prop_types62.default.oneOfType([import_prop_types62.default.shape({
      colors: import_prop_types62.default.arrayOf(import_prop_types62.default.string).isRequired,
      type: import_prop_types62.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types62.default.oneOfType([import_prop_types62.default.instanceOf(Date), import_prop_types62.default.number]),
    min: import_prop_types62.default.oneOfType([import_prop_types62.default.instanceOf(Date), import_prop_types62.default.number]),
    position: import_prop_types62.default.oneOf(["left", "right"]),
    reverse: import_prop_types62.default.bool,
    scaleType: import_prop_types62.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types62.default.object,
    slots: import_prop_types62.default.object,
...
function Scatter(props) {
  ...
  } = React127.useContext(InteractionContext);
  ...
  const cleanData = React127.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
    const temp = [];
  ...
  return (0, import_jsx_runtime83.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime83.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
true ? Scatter.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  color: import_prop_types63.default.string.isRequired,
  colorGetter: import_prop_types63.default.func,
  markerSize: import_prop_types63.default.number.isRequired,
  /**
   * Callback fired when clicking on a scatter item.
  ...
  series: import_prop_types63.default.object.isRequired,
  xScale: import_prop_types63.default.func.isRequired,
  yScale: import_prop_types63.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React128.useContext(ZAxisContext);
  if (seriesData === void 0) {
    return null;
  }
  const {
  ...
  return (0, import_jsx_runtime84.jsx)(React128.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
      ...
      const xScale = xAxis[xAxisId ?? xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisId ?? yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime84.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color3,
        colorGetter,
...
var ScatterChart = React129.forwardRef(function ScatterChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
  ...
  return (0, import_jsx_runtime85.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime85.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime85.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime85.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime85.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime85.jsx)("g", {
        "data-drawing-container": true,
        children: (0, import_jsx_runtime85.jsx)(ScatterPlot, _extends({}, scatterPlotProps))
      }), (0, import_jsx_runtime85.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime85.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime85.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime85.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
true ? ScatterChart.propTypes = {
   ...
   * @default { x: 'none', y: 'none' }
   */
  axisHighlight: import_prop_types65.default.shape({
    x: import_prop_types65.default.oneOf(["band", "line", "none"]),
    y: import_prop_types65.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types65.default.oneOfType([import_prop_types65.default.object, import_prop_types65.default.string]),
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types65.default.oneOfType([import_prop_types65.default.arrayOf(import_prop_types65.default.string), import_prop_types65.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types65.default.arrayOf(import_prop_types65.default.object),
   ...
   * @default false
   */
  disableAxisListener: import_prop_types65.default.bool,
  /**
   * If true, the interaction will not use the Voronoi cell and fall back to hover events.
   * @default false
   */
  disableVoronoi: import_prop_types65.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types65.default.shape({
    horizontal: import_prop_types65.default.bool,
    vertical: import_prop_types65.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * The item currently highlighted. Turns highlighting into a controlled prop.
   */
  highlightedItem: import_prop_types65.default.shape({
    dataIndex: import_prop_types65.default.number,
    seriesId: import_prop_types65.default.oneOfType([import_prop_types65.default.number, import_prop_types65.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types65.default.oneOfType([import_prop_types65.default.object, import_prop_types65.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types65.default.shape({
    classes: import_prop_types65.default.object,
    direction: import_prop_types65.default.oneOf(["column", "row"]),
    hidden: import_prop_types65.default.bool,
    itemGap: import_prop_types65.default.number,
    itemMarkHeight: import_prop_types65.default.number,
    itemMarkWidth: import_prop_types65.default.number,
    labelStyle: import_prop_types65.default.object,
    markGap: import_prop_types65.default.number,
    onItemClick: import_prop_types65.default.func,
    padding: import_prop_types65.default.oneOfType([import_prop_types65.default.number, import_prop_types65.default.shape({
    ...
    position: import_prop_types65.default.shape({
      horizontal: import_prop_types65.default.oneOf(["left", "middle", "right"]).isRequired,
      vertical: import_prop_types65.default.oneOf(["bottom", "middle", "top"]).isRequired
    }),
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types65.default.shape({
    bottom: import_prop_types65.default.number,
    left: import_prop_types65.default.number,
    right: import_prop_types65.default.number,
    top: import_prop_types65.default.number
   ...
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   */
  onHighlightChange: import_prop_types65.default.func,
  /**
   * Callback fired when clicking on a scatter item.
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types65.default.bool,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types65.default.oneOfType([import_prop_types65.default.object, import_prop_types65.default.string]),
  /**
   * The series to display in the scatter chart.
   * An array of [[ScatterSeriesType]] objects.
   */
  series: import_prop_types65.default.arrayOf(import_prop_types65.default.object).isRequired,
  /**
   * If `true`, animations are skipped.
   * If unset or `false`, the animations respects the user's `prefers-reduced-motion` setting.
   */
   ...
   * @default { trigger: 'item' }
   */
  tooltip: import_prop_types65.default.shape({
    axisContent: import_prop_types65.default.elementType,
    classes: import_prop_types65.default.object,
    itemContent: import_prop_types65.default.elementType,
    slotProps: import_prop_types65.default.object,
    slots: import_prop_types65.default.object,
    trigger: import_prop_types65.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types65.default.oneOfType([import_prop_types65.default.object, import_prop_types65.default.string]),
  viewBox: import_prop_types65.default.shape({
    height: import_prop_types65.default.number,
    width: import_prop_types65.default.number,
    x: import_prop_types65.default.number,
    y: import_prop_types65.default.number
  }),
  /**
   * Defines the maximal distance between a scatter point and the pointer that triggers the interaction.
   * If `undefined`, the radius is assumed to be infinite.
   */
  voronoiMaxRadius: import_prop_types65.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
  width: import_prop_types65.default.number,
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types65.default.arrayOf(import_prop_types65.default.shape({
    classes: import_prop_types65.default.object,
    colorMap: import_prop_types65.default.oneOfType([import_prop_types65.default.shape({
      colors: import_prop_types65.default.arrayOf(import_prop_types65.default.string).isRequired,
      type: import_prop_types65.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types65.default.string,
      values: import_prop_types65.default.arrayOf(import_prop_types65.default.oneOfType([import_prop_types65.default.instanceOf(Date), import_prop_types65.default.number, import_prop_types65.default.string]).isRequired)
    }), import_prop_types65.default.shape({
      color: import_prop_types65.default.oneOfType([import_prop_types65.default.arrayOf(import_prop_types65.default.string.isRequired), import_prop_types65.default.func]).isRequired,
      max: import_prop_types65.default.oneOfType([import_prop_types65.default.instanceOf(Date), import_prop_types65.default.number]),
      min: import_prop_types65.default.oneOfType([import_prop_types65.default.instanceOf(Date), import_prop_types65.default.number]),
      type: import_prop_types65.default.oneOf(["continuous"]).isRequired
    }), import_prop_types65.default.shape({
      colors: import_prop_types65.default.arrayOf(import_prop_types65.default.string).isRequired,
      thresholds: import_prop_types65.default.arrayOf(import_prop_types65.default.oneOfType([import_prop_types65.default.instanceOf(Date), import_prop_types65.default.number]).isRequired).isRequired,
      type: import_prop_types65.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types65.default.array,
    dataKey: import_prop_types65.default.string,
    disableLine: import_prop_types65.default.bool,
    disableTicks: import_prop_types65.default.bool,
    domainLimit: import_prop_types65.default.oneOfType([import_prop_types65.default.oneOf(["nice", "strict"]), import_prop_types65.default.func]),
    fill: import_prop_types65.default.string,
    hideTooltip: import_prop_types65.default.bool,
    id: import_prop_types65.default.oneOfType([import_prop_types65.default.number, import_prop_types65.default.string]),
    label: import_prop_types65.default.string,
    labelFontSize: import_prop_types65.default.number,
    labelStyle: import_prop_types65.default.object,
    max: import_prop_types65.default.oneOfType([import_prop_types65.default.instanceOf(Date), import_prop_types65.default.number]),
    min: import_prop_types65.default.oneOfType([import_prop_types65.default.instanceOf(Date), import_prop_types65.default.number]),
    position: import_prop_types65.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types65.default.bool,
    scaleType: import_prop_types65.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types65.default.object,
    slots: import_prop_types65.default.object,
    stroke: import_prop_types65.default.string,
    sx: import_prop_types65.default.oneOfType([import_prop_types65.default.arrayOf(import_prop_types65.default.oneOfType([import_prop_types65.default.func, import_prop_types65.default.object, import_prop_types65.default.bool])), import_prop_types65.default.func, import_prop_types65.default.object]),
    tickFontSize: import_prop_types65.default.number,
    tickInterval: import_prop_types65.default.oneOfType([import_prop_types65.default.oneOf(["auto"]), import_prop_types65.default.array, import_prop_types65.default.func]),
    tickLabelInterval: import_prop_types65.default.oneOfType([import_prop_types65.default.oneOf(["auto"]), import_prop_types65.default.func]),
    tickLabelPlacement: import_prop_types65.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types65.default.object,
    tickMaxStep: import_prop_types65.default.number,
    tickMinStep: import_prop_types65.default.number,
    tickNumber: import_prop_types65.default.number,
    tickPlacement: import_prop_types65.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types65.default.number,
    valueFormatter: import_prop_types65.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types65.default.arrayOf(import_prop_types65.default.shape({
    classes: import_prop_types65.default.object,
    colorMap: import_prop_types65.default.oneOfType([import_prop_types65.default.shape({
      colors: import_prop_types65.default.arrayOf(import_prop_types65.default.string).isRequired,
      type: import_prop_types65.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types65.default.oneOfType([import_prop_types65.default.instanceOf(Date), import_prop_types65.default.number]),
    min: import_prop_types65.default.oneOfType([import_prop_types65.default.instanceOf(Date), import_prop_types65.default.number]),
    position: import_prop_types65.default.oneOf(["left", "right"]),
    reverse: import_prop_types65.default.bool,
    scaleType: import_prop_types65.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types65.default.object,
    slots: import_prop_types65.default.object,
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types65.default.arrayOf(import_prop_types65.default.shape({
    colorMap: import_prop_types65.default.oneOfType([import_prop_types65.default.shape({
      colors: import_prop_types65.default.arrayOf(import_prop_types65.default.string).isRequired,
      type: import_prop_types65.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types65.default.string,
...
var SparkLineChart = React130.forwardRef(function SparkLineChart2(props, ref) {
  const {
    xAxis,
    yAxis,
    width: width2,
  ...
  return (0, import_jsx_runtime86.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime86.jsx)(BarPlot, {
      skipAnimation: true,
      slots,
      slotProps
    }), plotType === "line" && (0, import_jsx_runtime86.jsxs)(React130.Fragment, {
      children: [(0, import_jsx_runtime86.jsx)(AreaPlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime86.jsx)(LinePlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime86.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime86.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime86.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  }));
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types66.default.bool,
  axisHighlight: import_prop_types66.default.shape({
    x: import_prop_types66.default.oneOf(["band", "line", "none"]),
    y: import_prop_types66.default.oneOf(["band", "line", "none"])
  }),
   ...
   * @default blueberryTwilightPalette
   */
  colors: import_prop_types66.default.oneOfType([import_prop_types66.default.arrayOf(import_prop_types66.default.string), import_prop_types66.default.func]),
  /**
   * @default 'linear'
   */
  curve: import_prop_types66.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types66.default.arrayOf(import_prop_types66.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types66.default.arrayOf(import_prop_types66.default.object),
  desc: import_prop_types66.default.string,
  /**
   * If `true`, the charts will not listen to the mouse move event.
   * It might break interactive features, but will improve performance.
   * @default false
   */
  disableAxisListener: import_prop_types66.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
  height: import_prop_types66.default.number,
  /**
   * The item currently highlighted. Turns highlighting into a controlled prop.
   */
  highlightedItem: import_prop_types66.default.shape({
    dataIndex: import_prop_types66.default.number,
    seriesId: import_prop_types66.default.oneOfType([import_prop_types66.default.number, import_prop_types66.default.string])
  }),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   ...
   * }
   */
  margin: import_prop_types66.default.shape({
    bottom: import_prop_types66.default.number,
    left: import_prop_types66.default.number,
    right: import_prop_types66.default.number,
    top: import_prop_types66.default.number
  }),
  /**
   * The callback fired when the highlighted item changes.
   *
   ...
   * @default 'line'
   */
  plotType: import_prop_types66.default.oneOf(["bar", "line"]),
  /**
   * The chart will try to wait for the parent container to resolve its size
   * before it renders for the first time.
   *
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types66.default.bool,
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types66.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types66.default.bool,
  /**
   * If `true`, animations are skipped.
   * If unset or `false`, the animations respects the user's `prefers-reduced-motion` setting.
   */
  ...
  tooltip: import_prop_types66.default.shape({
    axisContent: import_prop_types66.default.elementType,
    classes: import_prop_types66.default.object,
    itemContent: import_prop_types66.default.elementType,
    slotProps: import_prop_types66.default.object,
    slots: import_prop_types66.default.object,
    trigger: import_prop_types66.default.oneOf(["axis", "item", "none"])
  }),
  /**
   ...
   */
  valueFormatter: import_prop_types66.default.func,
  viewBox: import_prop_types66.default.shape({
    height: import_prop_types66.default.number,
    width: import_prop_types66.default.number,
    x: import_prop_types66.default.number,
    y: import_prop_types66.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
   ...
   */
  xAxis: import_prop_types66.default.shape({
    classes: import_prop_types66.default.object,
    colorMap: import_prop_types66.default.oneOfType([import_prop_types66.default.shape({
      colors: import_prop_types66.default.arrayOf(import_prop_types66.default.string).isRequired,
      type: import_prop_types66.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types66.default.string,
      values: import_prop_types66.default.arrayOf(import_prop_types66.default.oneOfType([import_prop_types66.default.instanceOf(Date), import_prop_types66.default.number, import_prop_types66.default.string]).isRequired)
    }), import_prop_types66.default.shape({
      color: import_prop_types66.default.oneOfType([import_prop_types66.default.arrayOf(import_prop_types66.default.string.isRequired), import_prop_types66.default.func]).isRequired,
      max: import_prop_types66.default.oneOfType([import_prop_types66.default.instanceOf(Date), import_prop_types66.default.number]),
      min: import_prop_types66.default.oneOfType([import_prop_types66.default.instanceOf(Date), import_prop_types66.default.number]),
      type: import_prop_types66.default.oneOf(["continuous"]).isRequired
    }), import_prop_types66.default.shape({
      colors: import_prop_types66.default.arrayOf(import_prop_types66.default.string).isRequired,
      thresholds: import_prop_types66.default.arrayOf(import_prop_types66.default.oneOfType([import_prop_types66.default.instanceOf(Date), import_prop_types66.default.number]).isRequired).isRequired,
      type: import_prop_types66.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types66.default.array,
    dataKey: import_prop_types66.default.string,
    disableLine: import_prop_types66.default.bool,
    disableTicks: import_prop_types66.default.bool,
    domainLimit: import_prop_types66.default.oneOfType([import_prop_types66.default.oneOf(["nice", "strict"]), import_prop_types66.default.func]),
    fill: import_prop_types66.default.string,
    hideTooltip: import_prop_types66.default.bool,
    id: import_prop_types66.default.oneOfType([import_prop_types66.default.number, import_prop_types66.default.string]),
    label: import_prop_types66.default.string,
    labelFontSize: import_prop_types66.default.number,
    labelStyle: import_prop_types66.default.object,
    max: import_prop_types66.default.oneOfType([import_prop_types66.default.instanceOf(Date), import_prop_types66.default.number]),
    min: import_prop_types66.default.oneOfType([import_prop_types66.default.instanceOf(Date), import_prop_types66.default.number]),
    position: import_prop_types66.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types66.default.bool,
    scaleType: import_prop_types66.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types66.default.object,
    slots: import_prop_types66.default.object,
    stroke: import_prop_types66.default.string,
    sx: import_prop_types66.default.oneOfType([import_prop_types66.default.arrayOf(import_prop_types66.default.oneOfType([import_prop_types66.default.func, import_prop_types66.default.object, import_prop_types66.default.bool])), import_prop_types66.default.func, import_prop_types66.default.object]),
    tickFontSize: import_prop_types66.default.number,
    tickInterval: import_prop_types66.default.oneOfType([import_prop_types66.default.oneOf(["auto"]), import_prop_types66.default.array, import_prop_types66.default.func]),
    tickLabelInterval: import_prop_types66.default.oneOfType([import_prop_types66.default.oneOf(["auto"]), import_prop_types66.default.func]),
    tickLabelPlacement: import_prop_types66.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types66.default.object,
    tickMaxStep: import_prop_types66.default.number,
    tickMinStep: import_prop_types66.default.number,
    tickNumber: import_prop_types66.default.number,
    tickPlacement: import_prop_types66.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types66.default.number,
    valueFormatter: import_prop_types66.default.func
  }),
  /**
   ...
   * Notice it is a single [[AxisConfig]] object, not an array of configuration.
   */
  yAxis: import_prop_types66.default.shape({
    classes: import_prop_types66.default.object,
    colorMap: import_prop_types66.default.oneOfType([import_prop_types66.default.shape({
      colors: import_prop_types66.default.arrayOf(import_prop_types66.default.string).isRequired,
      type: import_prop_types66.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types66.default.oneOfType([import_prop_types66.default.instanceOf(Date), import_prop_types66.default.number]),
    min: import_prop_types66.default.oneOfType([import_prop_types66.default.instanceOf(Date), import_prop_types66.default.number]),
    position: import_prop_types66.default.oneOf(["left", "right"]),
    reverse: import_prop_types66.default.bool,
    scaleType: import_prop_types66.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types66.default.object,
    slots: import_prop_types66.default.object,
...
var GaugeContext = React131.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function GaugeProvider(props) {
  ...
  return (0, import_jsx_runtime87.jsx)(GaugeContext.Provider, {
    value: contextValue,
    children
  });
}
function useGaugeState() {
  return React131.useContext(GaugeContext);
}
...
var GaugeContainer = React132.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin: margin2,
  ...
  const svgRef = React132.useRef(null);
  const chartSurfaceRef = useForkRef(ref, svgRef);
  return (0, import_jsx_runtime88.jsx)(ResizableContainer2, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width2 && height2 ? (0, import_jsx_runtime88.jsx)(DrawingProvider, {
      width: width2,
      height: height2,
      margin: _extends({
        left: 10,
      ...
      svgRef,
      children: (0, import_jsx_runtime88.jsx)(GaugeProvider, {
        value,
        valueMin,
        valueMax,
        startAngle,
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime88.jsx)(ChartsSurface, {
          width: width2,
          height: height2,
          ref: chartSurfaceRef,
          title,
...
true ? GaugeContainer.propTypes = {
   ...
   * @default 0
   */
  cornerRadius: import_prop_types67.default.oneOfType([import_prop_types67.default.number, import_prop_types67.default.string]),
  /**
   * The x coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the width the drawing area.
   */
  cx: import_prop_types67.default.oneOfType([import_prop_types67.default.number, import_prop_types67.default.string]),
  /**
   * The y coordinate of the arc center.
   * Can be a number (in px) or a string with a percentage such as '50%'.
   * The '100%' is the height the drawing area.
   */
  cy: import_prop_types67.default.oneOfType([import_prop_types67.default.number, import_prop_types67.default.string]),
   ...
   * @default 360
   */
  endAngle: import_prop_types67.default.number,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * @default '80%'
   */
  innerRadius: import_prop_types67.default.oneOfType([import_prop_types67.default.number, import_prop_types67.default.string]),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   * Accepts an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   ...
   * @default '100%'
   */
  outerRadius: import_prop_types67.default.oneOfType([import_prop_types67.default.number, import_prop_types67.default.string]),
  /**
   * The start angle (deg).
   * @default 0
   */
  startAngle: import_prop_types67.default.number,
   ...
   * @default 100
   */
  valueMax: import_prop_types67.default.number,
  /**
   * The minimal value of the gauge.
   * @default 0
   */
  valueMin: import_prop_types67.default.number,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime89.jsx)(StyledPath, _extends({
...
function GaugeReferenceArc(props) {
  ...
  return (0, import_jsx_runtime90.jsx)(StyledPath2, _extends({
    transform: `translate(${cx}, ${cy})`,
    d: arc_default().cornerRadius(cornerRadius)({
      startAngle,
      endAngle,
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime91.jsx)("g", {
    className,
    children: (0, import_jsx_runtime91.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
true ? GaugeValueText.propTypes = {
   ...
   * Height of a text line (in `em`).
   */
  lineHeight: import_prop_types68.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types68.default.bool,
  ownerState: import_prop_types68.default.any,
  /**
   * Style applied to text elements.
   */
...
var Gauge = React136.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className
  ...
  return (0, import_jsx_runtime92.jsxs)(GaugeContainer, _extends({}, other, {
    className: clsx_default(classes.root, className),
    ref,
    children: [(0, import_jsx_runtime92.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime92.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime92.jsx)(GaugeValueText, {
...
true ? Gauge.propTypes = {
  ...
  text: import_prop_types69.default.oneOfType([import_prop_types69.default.func, import_prop_types69.default.string]),
